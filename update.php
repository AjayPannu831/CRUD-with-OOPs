    ...
    <div class="container">
        <form method="post" action="" enctype="multipart/form-data" name="form" onsubmit="return validateForm()">
            ...
            if(isset($_GET['id']) && !empty($_GET['id'])) {
                ...
                ?>
                <input type="hidden" class="form-control" name="id" value="<?php echo $customers['id'] ?>">
                <!-- First Name Input -->
                <div class="mb-3 mt-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="password" id="password" value="<?php echo $customers['password'] ?>">
                ...
                <div class="mb-3">
                    ...
                    <input type="password" class="form-control" name="cpassword" id="cpassword" value="<?php echo $customers['confirm'] ?>">
